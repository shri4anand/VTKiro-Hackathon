...
export const SimplifierPanel: React.FC<SimplifierPanelProps> = ({
  ...
  return (
    <div
      className={`absolute top-4 left-4 max-h-[calc(100vh-2rem)] overflow-y-auto overflow-x-hidden bg-white rounded-lg shadow-lg z-10 transition-all duration-300 ease-in-out motion-reduce:transition-none ${
